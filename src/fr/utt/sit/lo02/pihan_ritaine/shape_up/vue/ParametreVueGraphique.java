...
//pour g√©n√©rer des boutons dynamiquement
...
//2nd bouton pour initialiser les parametres
	...
	//	La fonction qui est appelÈe quand on crÈe lance un Thread de cette classe
	public void run() {
		try {
			//	On affiche juste la frame car l'initialisation a ÈtÈ faite avant d'appeler le Thread
